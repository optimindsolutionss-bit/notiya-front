...
import { AppBar, Toolbar, IconButton, Typography, Tooltip, Badge, Avatar, Menu, MenuItem, ListItemIcon, Divider, Box } from "@mui/material";
...
export default function HeaderBar({ esMovil, onMenuClick }) {
